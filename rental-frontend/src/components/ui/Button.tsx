...
const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  ({ 
    ...
    const variants = {
      ...
      secondary: 'bg-background-tertiary hover:bg-background-tertiary/80 text-foreground focus:ring-background-tertiary',
      outline: 'border border-foreground-secondary hover:bg-background-secondary text-foreground focus:ring-primary',
